...
![UWP Radial Gauge scale](Scales_images/Scales_img1.png)
...
![UWP Radial Gauge scale start and end values](Scales_images/Scales_img2.png)
...
![UWP Radial Gauge scale start and sweep angles](Scales_images/Scales_img3.png)
...
![UWP Radial Gauge scale interval](Scales_images/Scales_img4.png)
...
![UWP Radial Gauge scale auto interval](Scales_images/Scales_img5.png)
...
![UWP Radial Gauge scale direction](Scales_images/Scales_img6.png)
            ...
            <gauge:CircularScale Radius="175" TickStroke="White" SmallTickStroke="White" LabelStroke="White">
                ...
                <gauge:CircularScale.Pointers>
                    <gauge:CircularPointer Value="30" PointerType="SymbolPointer" Symbol="InvertedArrow"
                                           SymbolPointerWidth="30" SymbolPointerHeight="20"
                                           SymbolPointerStroke="Green" SymbolPointerBorderBrush="Green"/>
                </gauge:CircularScale.Pointers>
            </gauge:CircularScale>
...
![UWP Radial Gauge multiple scales](Scales_images/Scales_img7.png)
...
![UWP Radial Gauge center aligned](Scales_images/iscenteraligned.jpg)
