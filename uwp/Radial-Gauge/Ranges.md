...
![UWP Radial Gauge range start and end values](Ranges_images/Ranges_img1.png)
...
![UWP Radial Gauge range customization](Ranges_images/Ranges_img2.png)
...
![UWP Radial Gauge range width](Ranges_images/Ranges_img3.png)
...
![UWP Radial Gauge binding range stroke](Ranges_images/Ranges_img4.png)
...
![UWP Radial Gauge range position](Ranges_images/Ranges_img5.png)
...
![UWP Radial Gauge range offset](Ranges_images/Ranges_img6.png)
...
![UWP Radial Gauge multiple ranges](Ranges_images/Ranges_img7.png)
...
circularRange.StartValue = 0;
circularRange.EndValue = 50;
ObservableCollection<GaugeGradientStop> gradientColor1 = new ObservableCollection<Syncfusion.UI.Xaml.Gauges.GaugeGradientStop>();
...
![UWP Radial Gauge gradient color for range](Ranges_images/Ranges_img8.png)
