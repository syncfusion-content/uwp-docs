---
layout: post
title: Getting Started with UWP Carousel | Syncfusion®
description: Learn how to get started with the Syncfusion® UWP Carousel (SfCarousel) control. Explore setup, features, examples, and customization options.
platform: uwp
control: SfCarousel
documentation: ug
---
