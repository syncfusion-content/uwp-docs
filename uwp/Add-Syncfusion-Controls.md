...
# Add Syncfusion&reg; UWP Controls
...
Syncfusion&reg; UI for UWP are added automatically to the Visual Studio Toolbox during installation. The following steps helps to add required Essential&reg; UWP control through drag and drop from Toolbox. For example: SfTextBoxExt 
...
Syncfusion&reg; UI for UWP can added at runtime using C# / VB. The following steps helps to add required Essential&reg; UWP control through code. For example: SfTextBoxExt.
...
I> The Syncfusion&reg; UWP project templates are available from Essential Studio&reg; v15.3.0.26.  
...
2.The following steps helps to add a required Essential&reg; UWP control through XAML code, for example: SfColorPicker
...
3.The following steps helps to add a required Essential&reg; UWP control through code, for example: SfColorPicker
