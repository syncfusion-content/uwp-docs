---
layout: post
title: SyncfusionUWPAssistant MCP Server | Syncfusion
description: Learn how to configure and use SyncfusionUWPAssistant MCP server for intelligent code generation, documentation, and troubleshooting in UWP apps.
platform: uwp
control: Getting started with SyncfusionUWPAssistant MCP Server
documentation: ug
---

# SyncfusionUWPAssistant MCP Server

## Overview

The [SyncfusionUWPAssistant](https://www.npmjs.com/package/@syncfusion/uwp-assistant) is a specialized [Model Context Protocol (MCP)](https://modelcontextprotocol.io/docs/getting-started/intro) server that provides intelligent assistance for developers using Syncfusion's UWP component libraries. This tool seamlessly integrates with compatible [MCP clients](https://modelcontextprotocol.io/clients) to enhance your development workflow when building UWP applications with Syncfusion<sup style="font-size:70%">&reg;</sup> components.

### Key Benefits

* Intelligent code generation for Syncfusion<sup style="font-size:70%">&reg;</sup> UWP components.
* Detailed component documentation and usage examples.
* Troubleshooting assistance for common integration challenges.

## Prerequisites

Before using [SyncfusionUWPAssistant](https://www.npmjs.com/package/@syncfusion/uwp-assistant), ensure you have:
...
Before you can invoke the `SyncfusionUWPAssistant` MCP server, you need to configure your MCP client with these core settings. The **Generic MCP Server Settings** shown below are identical across all clients:

### Generic MCP Server Settings

- **npm package name**: `@syncfusion/uwp-assistant`
- **Type**: stdio (standard input/output transport)
- **Command**: npx
- **Arguments**: -y
- **Server name**: SyncfusionUWPAssistant
...
* Enter the Server Name as `uwp-mcp`, choose Server Type as npm package, and set the NPM Package name to `@syncfusion/uwp-assistant`.
...
{
  "servers": {
    "syncfusion-uwp-assistant": {
      "type": "stdio",
      "command": "npx",
      "args": [
        "-y",
        "@syncfusion/uwp-assistant@latest"
      ],
      "env": {
        "Syncfusion_API_Key": "YOUR_API_KEY"
      }
...
* After updating the configuration in mcp.json, you'll notice a "Start" option at the top of the config. This allows you to easily start the [SyncfusionUWPAssistant](https://www.npmjs.com/package/@syncfusion/uwp-assistant) server directly from the settings interface without additional commands.

* Confirm the server is active by checking for a message like: `SyncfusionUWPAssistant is running...` in the output.
...
* Select the [SyncfusionUWPAssistant](https://www.npmjs.com/package/@syncfusion/uwp-assistant) from the tools section.
...
To activate the SyncfusionUWPAssistant MCP server:

1. Start your prompt with one of the following:
    * 'SyncfusionUWPAssistant'
    * '/syncfusion-uwp-assistant'
    * '/syncfusion-uwp'
    * '@syncfusion-uwp'
    * '@ask_syncfusion_uwp'
   ...
   In VS Code, you can also use #SyncfusionUWPAssistant for direct invocation.
...
1. `Be specific`: Mention both platform and component (e.g., "How do I create a Syncfusion UWP DataGrid with paging and filtering?").
...
Here are some effective ways to use [SyncfusionUWPAssistant](https://www.npmjs.com/package/@syncfusion/uwp-assistant):

 * "Create a Syncfusion UWP DataGrid component with paging, sorting and filtering"
 * "How do I implement data binding with Syncfusion UWP Scheduler?"
...
* [Community forum](https://www.syncfusion.com/forums/uwp)
* [Request feature or report bug](https://www.syncfusion.com/feedback/uwp)
* Live chat

## See also

* [Syncfusion UWP Documentation](https://help.syncfusion.com/uwp/overview)
