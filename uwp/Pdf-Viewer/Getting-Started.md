...
![Dependent assemblies needed for UWP SfPdfViewerControl](getting-started-images/uwp-pdf-viewer-required-assemblies.jpeg)
...
![UWP SfPdfViewerControl in visual studio toolbox](getting-started-images/uwp-pdf-viewer-create-a-simple-application.jpeg)
...
![Supported input interactions in UWP SfPdfViewerControl](getting-started-images/uwp-pdf-viewer-supported-input-interaction.jpeg)
