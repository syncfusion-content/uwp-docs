...
<gauge:SfLinearGauge>
    <gauge:SfLinearGauge.MainScale>
        <gauge:LinearScale Interval="10"
                           MajorTickStroke="Gray" MajorTickSize="25" MinorTickSize="12" LabelSize="15" ScaleBarSize="20"
...
![UWP Linear Gauge scale](Scales_images/Scales_img1.png)
...
![UWP Linear Gauge minimum and maximum values](Scales_images/Scales_img2.png)
...
![UWP Linear Gauge interval](Scales_images/Scales_img3.png)
...
![UWP Linear Gauge scale customization](Scales_images/Scales_img4.png)
...
![UWP Linear Gauge scale direction](Scales_images/Scales_img5.png)
...
![UWP Linear Gauge scale position](Scales_images/Scales_img6.png)
...
![UWP Linear Gauge corner radius](Scales_images/Scales_img7.png)
...
![UWP Linear Gauge gradient color](Scales_images/Scales_img8.png)
