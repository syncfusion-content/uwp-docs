...
![UWP Linear Gauge label color customization](Labels_images/Labels_img1.png)
...
![UWP Linear Gauge label font customization](Labels_images/Labels_img2.png)
...
![UWP Linear Gauge label position](Labels_images/Labels_img3.png)
...
![UWP Linear Gauge label postfix](Labels_images/Labels_img4.png)
...
![UWP Linear Gauge label prefix](Labels_images/Labels_img5.png)
...
![UWP Linear Gauge label offset](Labels_images/Labels_img6.png)
...
![UWP Linear Gauge labels visibility](Labels_images/Labels_img7.png)
...
<gauge:SfLinearGauge>
    <gauge:SfLinearGauge.MainScale>
        <gauge:LinearScale MaximumLabels="4" ScaleOffset="50" Minimum="10" Maximum="50" Interval="10"
                           ScaleBarStroke="#E0E0E0" ScaleBarSize="10" MinorTicksPerInterval="1"
                           LabelStroke="#000000" LabelSize="20" LabelFormat="{}{0:c2}" LabelOffset="10">
...
![UWP Linear Gauge label format](Labels_images/labelFormat.png)
