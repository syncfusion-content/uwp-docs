...
4. After you've started the trial, go to the [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page to get the latest version trial installer. You can generate the [unlock key](https://support.syncfusion.com/kb/article/7053/how-to-generate-unlock-key-for-essentials-studio-products) and [license key](https://help.syncfusion.com/uwp/licensing/how-to-generate) here at any time before the trial period expires (as shown in the screenshot below).
...
8. After downloading, the Syncfusion UWP web installer can be unlocked using your Syncfusion registered login credential.
...
Refer to the [**web installer**](https://help.syncfusion.com/uwp/installation/web-installer/how-to-install) link for step-by-step installation guidelines.	
