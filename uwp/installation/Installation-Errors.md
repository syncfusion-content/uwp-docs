...
* [Unable to install due to controlled folder access](http://help.syncfusion.com/uwp/installation/installation-errors#unable-to-install-due-to-controlled-folder-access)
