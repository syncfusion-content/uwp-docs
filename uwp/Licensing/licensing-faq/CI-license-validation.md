...
* Once the license key is registered, it can be validated by using the ValidateLicense("Platform.UWP", out var validationMessage) method. This ensures that the license key is valid for the platform and version you are using.
...
{% tabs %}
{% highlight c# %}
public void TestSyncfusionUWPLicense()
{
	var platform = Platform.UWP;
