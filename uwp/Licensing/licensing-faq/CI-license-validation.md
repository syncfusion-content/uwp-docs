...
* Once the license key is registered, it can be validated by using ValidateLicense("Platform.UWP") method. This ensures that the license key is valid for the platform and version you are using. For reference please check the following example.
