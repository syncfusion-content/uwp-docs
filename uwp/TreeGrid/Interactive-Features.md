---
layout: post
title: Interactive Features in UWP TreeGrid | Syncfusion®
description: Interactive Features in UWP TreeGrid provide context menus for cells, rows, headers, and expanders with full customization.
platform: uwp
control: TreeGrid
documentation: ug
---
