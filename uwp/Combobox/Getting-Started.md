...
![Showing itemsource property of UWP sfcombobox](populating-items-images/uwp-combobox-populate-the-items.png)
...
![Showing product name of the UWP sfcombobox](populating-items-images/uwp-combobox-display-member-path.png)
...
![Item Template in UWP sfcombobox](populating-items-images/uwp-combobox-item-template.png)