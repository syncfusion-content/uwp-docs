...
This table represents the Syncfusion<sup>&reg;</sup> Essential Studio<sup>&reg;</sup> UWP controls supported .NET Framework versions:
...
Syncfusion<sup>&reg;</sup> UWP controls are always updated with the Microsoft latest Framework. The following table contains information about the control’s compatibility with the versions of .NET Framework:
