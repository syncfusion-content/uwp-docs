...
description: Learn about the Percent Display Mode in the Syncfusion® UWP SfNumericUpDown control using the PercentDisplayMode property with Value and Compute options.
platform: uwp
