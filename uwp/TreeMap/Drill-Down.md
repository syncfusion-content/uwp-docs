...
Treemap items can be drilled down by enabling the property EnableDrillDown to **true**. The hierarchy of treemap levels can be shown by clicking on treemap items. The previous level can be drilled up by clicking on the drill down header. The DrillDown header can be customized with the help of the DrillDownHeaderTemplate property.
