...
description: Learn about Validation Modes support in Syncfusion UWP Gantt Chart using Manual and Auto validation modes to manage task dates, dependencies, and non-working days.
platform: uwp
control: SfGantt
documentation: ug
---
