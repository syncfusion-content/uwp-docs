...
The Interval property is used to calculate the major tick count for a UWP Bullet Graph. Similarly, minor ticks are calculated using the MinorTicksPerInterval property.
