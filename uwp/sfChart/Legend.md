...
The following code example shows how to create a simple legend. For sample data, refer to the data section in the code example of [Line Series](http://help.syncfusion.com/uwp/sfchart/series#lineseries).
...
CheckBox- It is used to show or collapse the associated series. By default, the CheckBox is collapsed. You can enable it by setting CheckBoxVisibility property in ChartLegend.
 ...
 Usually, a legend item provides information about a series. However, for series like PieSeries, each legend item provides information about a single data point.
...
The following code example shows how to create multiple legends in a single chart. For sample data, please refer to the data section in the code sample of [Line Series.](http://help.syncfusion.com/wp8/sfchart/series#lineseries)
{% tabs %}
{% highlight xml %}
...
![](Legend_images/Legend_img2.png)
 ...
 You can change the legend visibility from chart series by using VisibilityOnLegend property
