...
![Adding UWP DataGrid control via Designer](getting-started_images/uwp-datagrid-control-adding-via-designer.png)
...
![Binding to Data in UWP DataGrid](getting-started_images/uwp-datagrid-binding-to-data.png)
...
![Sorting in UWP DataGrid](getting-started_images/uwp-datagrid-sorting.png)
...
![Grouping in UWP DataGrid](getting-started_images/uwp-datagrid-grouping.png)
...
![Filtering in UWP DataGrid](getting-started_images/uwp-datagrid-filtering.png)
