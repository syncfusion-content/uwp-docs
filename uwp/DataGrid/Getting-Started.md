...
![Adding control via Designer](Getting-Started_images/uwp-datagrid-adding-control-via-designer.png)
...
![Binding to Data](Getting-Started_images/uwp-datagrid-binding-to-data.png)
...
![Sorting](Getting-Started_images/uwp-datagrid-sorting.png)
...
![Grouping](Getting-Started_images/uwp-datagrid-grouping.png)
...
![Filtering](Getting-Started_images/uwp-datagrid-filtering.png)
