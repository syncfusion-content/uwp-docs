...
1.	Right-click the project or solution in the Solution Explorer tab, and choose **Manage NuGet Packages…**
    ...
    ![UWP Visual Studio Integration NuGet package manager add-in for windows](nuget-packages-images/uwp-visual-studio-integration-nuget-packages-installation.png)
...
2.	Select the NuGet.org from the **Package source** drop-down.  
     ...
     ![UWP Visual Studio Integration NuGet package manager dialog window](nuget-packages-images/uwp-visual-studio-integration-nuget-package-source.png)             
...
2. Click the Copy URL label under UWP platform to copy the Syncfusion UWP platform NuGet feed to clipboard or directly use the following URL: 
    ...
    ![Syncfusion UWP NuGet feed URL](nuget-packages-images/uwp-visual-studio-integration-nuget-packages.png)
...
5.	Click the **Update** button to add the name and source details to package sources. 
    ...
    ![NuGet Package Manager dialog with Syncfusion UWP NuGet feed URL for reference](nuget-packages-images/uwp-visual-studio-integration-nuget-packages-update.png)
