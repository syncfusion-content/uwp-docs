...
1. To create a Syncfusion UWP project, follow either one of the options below:
   ...
   **Option 2:**  
   ...
   ![Choose Syncfusion Universal Windows Application from Visual Studio new project dialog](Syncfusion-Project-Templates_images/uwp-visual-studio-integration-create-application.png)
   ...
   ![Choose Syncfusion Universal Windows Application from Visual Studio new project dialog](Syncfusion-Project-Templates_images/uwp-visual-studio-integration-new-project.jpeg)
...
3. Then Project Configuration Wizard appears. Choose the options to configure the Syncfusion Universal Windows Application by using the following Project Configuration dialog.
   ...
   **Components:** Choose the required Syncfusion components to configure.
   ...
   ![Syncfusion UWP Project configuration wizard](Syncfusion-Project-Templates_images/uwp-visual-studio-integration-project-configuration.jpeg)
...
4. After click **Create** button, the Syncfusion UWP Application is created with required SDK/references and pages.
   ...
   ![Syncfusion UWP Project created with SDK reference](Syncfusion-Project-Templates_images/uwp-visual-studio-integration-create-project.jpeg)

   ![Syncfusion UWP Project created with readme](Syncfusion-Project-Templates_images/uwp-visual-studio-integration-uwp-application.PNG)
