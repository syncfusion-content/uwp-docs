...
2. Set [SfDataPager.PageSize](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassPageSizeTopic.html) property to specify the number of records to be displayed per page.
3. Bind [SfDataPager.PagedSource](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassPagedSourceTopic.html) to [SfDataGrid.ItemsSource](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlGridSfDataGridClassItemsSourceTopic.html) property. So whenever the page is changed, `PagedSource` will be update based on current page.
...
1. Set [SfDataPager.UseOnDemandPaging](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassUseOnDemandPagingTopic.html) as `true`. 
2. Set [SfDataPager.PageCount](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassPageCountTopic.html) based on total number of records and [SfDataPager.PageSize](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/index.html#frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassPageSizeTopic.html) property.
3. Use [OnDemandLoading](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassOnDemandLoadingTopic.html) event to load the `ItemsSource` for current page using [LoadDynamicItems](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassLoadDynamicItemsTopic.html) method.
...
[OnDemandLoadingEventArgs](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerOnDemandLoadingEventArgsClassTopic.html) has the following members,
...
You can clear the cache by using [PageCollectionView.ResetCache](https://help.syncfusion.com/cr/cref_files/uwp/data/frlrfSyncfusionDataPagedCollectionViewClassResetCacheTopic.html) method. Once this method is invoked, the ‘OnDemandLoading’ event will be raised while navigating multiple times to the same page.
...
You can also clear the cache to particular page by specifying the `PageIndex` in [PageCollectionView.ResetCacheForPage](https://help.syncfusion.com/cr/cref_files/uwp/data/frlrfSyncfusionDataPagedCollectionViewClassResetCacheForPageTopic.html) method.
...
You can change the [SfDataPager.PageCount](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlControlsDataPagerSfDataPagerClassPageCountTopic.html) at runtime based on the records count in ‘OnDemandPaging’. 
...
You can sort the complete collection with ‘OnDemandPaging’ by using [SfDataGrid.SortColumnsChanging](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlGridSfDataGridClassSortColumnsChangingTopic.html) event.
