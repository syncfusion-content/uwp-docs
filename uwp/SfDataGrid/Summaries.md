...
By default, the summary value displayed in CaptionSummaryRow based on `SfDataGrid.GroupCaptionTextFormat` property. The default group caption format is `{ColumnName}: {Key} - {ItemsCount} Items`.
