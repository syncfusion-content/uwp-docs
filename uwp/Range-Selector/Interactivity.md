...
<chart:SfDateTimeRangeNavigator x:Name="RangeNavigator" Width="700" Height="179" 
                                ViewRangeStart="February,2015" ViewRangeEnd="March,2015"
                                XBindingPath="Date" ItemsSource="{Binding StockPriceDetails}">
...
<chart:SfChart VerticalAlignment="Bottom"
    ...
    <chart:SfChart.SecondaryAxis>
        <chart:NumericalAxis Minimum="820"
                             Interval="20"
                             Maximum="900"
                             FontSize="12"
    ...
    <chart:CandleSeries Name="series"
...
<chart:SfChart VerticalAlignment="Bottom"
    ...
    <chart:CandleSeries Name="series"
                        ItemsSource="{Binding ElementName=RangeNavigator,
                                              Path=SelectedData}"
                        XBindingPath="Date"
                        High="High"
                        Open="Open"
...
The following output is displayed as the result of the above code sample.
