...
description: Learn how to customize the appearance and styling of the Syncfusion® UWP SfTabControl control using HeaderTemplate and HeaderTemplateSelector properties.
platform: uwp
