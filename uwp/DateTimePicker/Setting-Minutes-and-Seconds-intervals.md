---
layout: post
title: Set Minute and Second Intervals in UWP DateTimePicker control | Syncfusion
description: Learn how to set minute and second intervals in the Syncfusion UWP DateTimePicker (SfDateTimeCombo) control.
platform: uwp
