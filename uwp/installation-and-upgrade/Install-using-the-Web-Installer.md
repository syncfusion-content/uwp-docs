...
The following procedure illustrates how to install Essential Studio for UWP Online Installer. 

1.  Double-click the Syncfusion UWP Online Installer setup file. The Setup Wizard opens and extracts the package automatically.

    ![](WebInstaller/Step-by-Step-Installation_img1.png)

    
    N> The Setup wizard extracts the syncfusionuwpwebinstaller_{version}.exe dialog, displaying the unzip operation of the package.
