---
layout: post
title: Formulas in SfCellGrid
description: List of formulas supported by SfCellGrid
platform: UWP
control: SfCellGrid
documentation: ug
---
...
To add formulas into a cell programmatically, set the `CellType` as "FormulaCell" and enter the formula in the `CellValue` property preceded with "=" sign.
...
N> If you are inserting the formula through button click event, then you need to invalidate that cell to update the view.
