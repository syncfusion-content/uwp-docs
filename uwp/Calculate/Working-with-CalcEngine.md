...
description: This section provides a basic idea of properties and methods maintained in CalcEngine for uwp/Syncfusion
platform: UWP
control: Calculate
documentation: ug
---
...
A method that parses and computes the string formula passed in. For more reference, see [here](https://help.syncfusion.com/uwp/calculate/parse-and-compute#parseandcomputeformula).

### ParseFormula

A method that parses the string formula passed in. For more reference, see [here](https://help.syncfusion.com/uwp/calculate/parse-and-compute#parse-formula).

### ComputeFormula

A method that computes a parsed formula. For more reference, see [here](https://help.syncfusion.com/uwp/calculate/parse-and-compute#computeformula).

### RegisterGridAsSheet

 A method that registers an `ICalcData` object so it can be referenced in a formula from another `ICalcData` object. For more reference, see [here](https://help.syncfusion.com/uwp/calculate/getting-started#cross-sheet-reference).
