...
The default number of decimal digits displayed based on `MaximumNumberDecimalDigits` property. Those default digits to be removed from numeric entry view by specified by using `AllowDefaultDecimalDigits` property. 
