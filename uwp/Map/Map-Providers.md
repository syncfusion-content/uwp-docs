---
layout: post
title: Map Providers in UWP Maps | Syncfusion®
description: Map providers in the UWP Maps supply map tile sources and geographic data, enabling visualization of locations and spatial information.
platform: uwp
control: SfMap
documentation: ug
---

# Map Providers in UWP Maps
