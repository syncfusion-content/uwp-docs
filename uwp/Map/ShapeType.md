...
description: Learn here all about Shape Types support in Syncfusion UWP Maps (SfMaps) control, its elements and more.
platform: uwp
control: SfMaps
documentation: ug
---
...
We can provide input as the Geo point collection in sample to draw a shape. We can add more number of shapes using [`SubShapeFileLayer`](https://help.syncfusion.com/uwp/map/multilayer-support#subshapefilelayers) support of Maps. There are three type of shapes available in shape file layer and it can be changed by using [`ShapeType`](https://help.syncfusion.com/cr/uwp/Syncfusion.UI.Xaml.Maps.ShapeFileLayer.html#Syncfusion_UI_Xaml_Maps_ShapeFileLayer_ShapeType) property.
