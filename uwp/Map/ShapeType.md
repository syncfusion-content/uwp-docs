                ...
                <maps:ImageryLayer.SubShapeFileLayers>
                    <maps:SubShapeFileLayer x:Name="subLayer">
                        <maps:SubShapeFileLayer.MapElements>
                            <maps:MapPolygon Points="{Binding PolygonPoints1, Source={StaticResource viewModel}}" Fill="Blue" Stroke="DarkBlue" StrokeThickness="4"/>
                            <maps:MapPolygon Points="{Binding PolygonPoints2, Source={StaticResource viewModel}}" Fill="Orange" Stroke="Red" StrokeThickness="4"/>
                        </maps:SubShapeFileLayer.MapElements>
...
![UWP Map Control Shape Types MapPolygon](Shape-Types/PolygonShape.png)
...
![UWP Map Control Shape Types MapPolyline](Shape-Types/PolylineShape.png)
...
![UWP Map Control Shape Types MapCircle](Shape-Types/PointIconShape.png)
    ...
    <maps:SfMap.Layers>
        <maps:ImageryLayer x:Name="layer" GeoCoordinates="42.9709225,-90.2187212">
            <maps:ImageryLayer.SubShapeFileLayers>
                <maps:SubShapeFileLayer x:Name="subLayer">
                    <maps:SubShapeFileLayer.MapElements>
                        <maps:MapCircle Fill="#3eFF0000" Stroke="#73FF0000" StrokeThickness="3" Radius="110">
                            <maps:MapCircle.Center>
                                <p:Point>43.76140927456403, -79.35451013248883</p:Point>
                            </maps:MapCircle.Center>
                        </maps:MapCircle>
...
![UWP Map Control Shape Types Customization of Map Elements](Shape-Types/MultiShapesCustomization.png)
            ...
            <maps:ImageryLayer.SubShapeFileLayers>
                <maps:SubShapeFileLayer x:Name="sublayer1" ShapeType="Polygon" Points="{Binding SubLayer1}">
                    <maps:SubShapeFileLayer.ShapeSettings>
                        <maps:ShapeSetting ShapeFill="Blue" ShapeStroke="DarkBlue" ShapeStrokeThickness="4"/>
                    </maps:SubShapeFileLayer.ShapeSettings>
                </maps:SubShapeFileLayer>
                <maps:SubShapeFileLayer x:Name="sublayer2" ShapeType="Polygon" Points="{Binding SubLayer2}">
                    <maps:SubShapeFileLayer.ShapeSettings>
                        <maps:ShapeSetting ShapeFill="Orange" ShapeStroke="Red" ShapeStrokeThickness="4"/>
                    </maps:SubShapeFileLayer.ShapeSettings>
                </maps:SubShapeFileLayer>
            </maps:ImageryLayer.SubShapeFileLayers>
        </maps:ImageryLayer>
...
![UWP Map Control Shape Types Point Collection Polygon](Shape-Types/PolygonShape.png)
...
![UWP Map Control Shape Types Point Collection Polyline](Shape-Types/PolylineShape.png)
...
![UWP Map Control Shape Types Point Collection Point Icon](Shape-Types/PointIconShape.png)
