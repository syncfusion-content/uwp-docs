...
<syncfusion:SfMap>
      ...
      <syncfusion:ShapeFileLayer ShapeIDPath="NAME" ShapeIDTableField="Continent" EnableSelection="True" Uri="MapApp.ShapeFiles.continent.shp">
            <syncfusion:ShapeFileLayer.MapPointTemplate>
                  <DataTemplate>
                  <Ellipse Height="10" Width="10" Stroke="White" Fill="#8AC63C"/>
                  </DataTemplate>
            </syncfusion:ShapeFileLayer.MapPointTemplate>
...
`MapPointPopup` is a popup displayed when the pointer is moved over a `MapPoint`. It shows additional information from the object bound with the `MapPoint`. You can get the object from the `.dbf` file.
...
<syncfusion:SfMap>
      <syncfusion:SfMap.Layers>
      <syncfusion:ShapeFileLayer Background="White" EnableSelection="True" Uri="MapApp.ShapeFiles.states.shp">
            <syncfusion:ShapeFileLayer.SubShapeFileLayers>
                  <syncfusion:SubShapeFileLayer EnableSelection="True" Uri="MapApp.ShapeFiles.landslide.shp">
...
![UWP Map Control Map Points MapPointPopup](Multilayer-Support_images/Multilayer-Support_img2.png)
