...
![Project Solution Window contains SfSparkline reference](Getting-started_images/GettingStarted_img2.png)
...
Some developers prefer code behind as the first approach for development, to create things dynamically. This section helps you to create a sparkline from code behind.
...
After you have added the sparkline, you need to add ItemsSource and YBindingPath APIs to populate your data in the sparkline.
...
The following code example gives the complete set of code for creating a sparkline in code behind.
...
//Setting ItemsSource and binding path
sfLineSparkline.ItemsSource = viewModel.UsersList;
sfLineSparkline.YBindingPath = "NoOfUsers";
