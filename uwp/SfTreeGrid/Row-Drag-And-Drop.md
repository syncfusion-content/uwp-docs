...
You can allow end-users to drag and drop the rows in SfTreeGrid and between two SfTreeGrid by setting [SfTreeGrid.AllowDraggingRows](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/index.html#frlrfSyncfusionUIXamlTreeGridSfTreeGridClassAllowDraggingRowsTopic.html) to `true`.It is also possible to drag and drop to and from any other control.
...
SfTreeGrid allows user to drag multiple selected nodes. You can enable multiple selection by setting  [SfTreeGrid.SelectionMode](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlGridSfGridBaseClassSelectionModeTopic.html) as `Multiple` or `Extended`.  
...
SfTreeGrid processes row drag and drop operations in [TreeGridRowDragDropController](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassTopic.html) class. You can customize the row drag and drop operations by overriding `TreeGridRowDragDropController` and set it to[SfTreeGrid.RowDragDropController](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridSfTreeGridClassRowDragDropControllerTopic.html).

### Disable dragging of certain nodes

If you want to restrict the dragging of specific node, you need to override [ProcessOnDragStarting](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/index.html#frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassProcessOnDragStartingTopic.html) method in [TreeGridRowDragDropController](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassTopic.html) class.
...
If you want to restrict the drop over specific node, you need to override [GetDropPosition](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassGetDropPositionTopic.html) method in [TreeGridRowDragDropController](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassTopic.html) class.
...
You can customize the drag UI text by overriding the [ProcessOnDragOver](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassProcessOnDragOverTopic.html) method in [TreeGridRowDragDropController](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassTopic.html) class.
...
public class TreeGridRowDragDropControllerExt : TreeGridRowDragDropController
{
    ...
    protected override void ProcessOnDragOver(DragEventArgs args, RowColumnIndex rowColumnIndex)
    {
        ...
        if (dropPosition == DropPosition.DropAbove)
            args.DragUIOverride.Caption = "über fallen";
    }
}
...
While dragging, all selected nodes will be added to dragging nodes collection. If you want to customize the dragging nodes collection, you need to override [ProcessOnDragOver](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassProcessOnDragOverTopic.html) method in [TreeGridRowDragDropController](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassTopic.html) class.
...
You can drag the item from ListView and drop into TreeGrid. For this, you need to override [GetDropPosition](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassGetDropPositionTopic.html),  [ProcessOnDragOver](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassProcessOnDragOverTopic.html), [ProcessOnDrop](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassProcessOnDropTopic.html) methods in [TreeGridRowDragDropController](https://help.syncfusion.com/cr/cref_files/uwp/sfdatagrid/frlrfSyncfusionUIXamlTreeGridTreeGridRowDragDropControllerClassTopic.html) class.
